...
public class DiaryBoardFolderChangeVO {
	...
	public DiaryBoardFolderChangeVO () {}

	public DiaryBoardFolderChangeVO(String userid, String folder_List, String old_folder, String new_folder) {
		super();
		this.userid = userid;
