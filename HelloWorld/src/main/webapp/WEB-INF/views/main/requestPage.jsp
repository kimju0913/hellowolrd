...
<div class = "requestPageMain">
	...
	<div id = "inputWrapper">
		...
		<label class = "lblAlert"> - 상대방이 동의하면 일촌이 맺어집니다.</label>
	</div>
	<br>
	<div id = "btnWrapper">
	...
	$(document).ready(function(){
		...
		$('#btnApply').click(function(){
			...
			var obj = {
	  	  	...
	  	  	$.ajax({
	  	  	  type : 'post',
	  	  	  url : '/helloworld/friend/sendRequest',
	  	  	  headers : {
	  	  	  ...
	  	  	  success : function(result){
	  	  	     if(result == 1){
	  	  	    	  alert('성공적으로 일촌신청이 되었습니다.');
	  	  	    	  window.close();
	  	  	      }else{
	  	  	    	  alert('이미 요청된 일촌신청입니다. 보낸일촌함 또는 받은일촌함을 확인하세요.');
	  	  	      }
