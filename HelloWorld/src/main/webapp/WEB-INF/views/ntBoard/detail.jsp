...
<div class = "main_form" style="width: 100%; height: 100%; margin-bottom: 0% "> <!-- mainform -->
   ...
   <hr>
      ...
      <pre style="font-size: 120%; height: 100%; overflow: auto;">${ntBoardVO.nt_content }</pre>
      ...
      <hr style="margin-bottom: 0px">
       ...
       <div class = "reply_form" style="background-color: #f1f3f5 "><!-- 댓글 부분 -->
          ...
          <div id = "replyInsert"><!-- 댓글 입력 부분 -->
             ...
             <button id = btnAddReply style = "width: 40px; height: 36px; margin-left: 5px; font-size: 12px;" > 확인 </button>    
          </div><!-- end replyInsert -->
          <br>
          <hr>
          <div id = "replyList">
...
<script type="text/javascript">
   function updateReplyReady(rno){
      ...
      inputBox += 
             ...
             '<textarea id = "nt_Ucontent" style = "width: 434px;height: 12px"></textarea>'
               + '&nbsp;'
   ...
   $(document).ready(function(){
      ...
      $('#fileUp a').click(function(){
         ...
         location.href = "fileDown?nt_bno=" + nt_bno + "&filecol="+encodeURI(fileName);   
      });
